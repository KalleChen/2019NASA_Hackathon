...
//     //   var position={latitude:0,lontitude:0};
//     //   var placemark = new WorldWind.Placemark(position, /*eyeDistanceScaling*/false, attributes);
...
var Tools = function (_Component) {
    ...
    {
        key: 'armDropMarker2',
        value: function armDropMarker2() {
            this.props.globe.armClickDrop(this.dropMarkerCallback2);
        }
    }, 
    {
        key:'dropMarkerCallback2',
        value: function dropMarkerCallback2(position){
            var attributes = new WorldWind.PlacemarkAttributes(null);
            attributes.imageScale = 0.08;
            attributes.imageOffset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, 0.3, WorldWind.OFFSET_FRACTION, 0.0);
            attributes.imageColor = WorldWind.Color.WHITE;
            attributes.labelAttributes.offset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, 0.5, WorldWind.OFFSET_FRACTION, 1.0);
            attributes.labelAttributes.color = WorldWind.Color.YELLOW;
            attributes.drawLeaderLine = true;
            attributes.leaderLineAttributes.outlineColor = WorldWind.Color.RED;
            attributes.imageSource = "https://i.imgur.com/zGLZKY8.png";
...

    {
        ...
        value: function dropMarkerCallback(position) {
            ...
            var source=[{latitude:90,longitude:90,mea:0},{latitude:0,longitude:0,mea:100}];
            ...
            attributes.drawLeaderLine = true;
            attributes.leaderLineAttributes.outlineColor = WorldWind.Color.RED;
            if(this.props.api[i].value<10){
            attributes.imageSource = "https://i.imgur.com/zGLZKY8.png";}
            else if(this.props.api[i].value<20){
                attributes.imageSource = "https://i.imgur.com/6nrew9K.png";
                attributes.imageScale = 0.2;
            }
            else{
                attributes.imageSource ="https://i.imgur.com/gQETEbi.png";  attributes.imageScale = 0.13;
            }
            // console.log(position);

            var b={
                latitude:this.props.api[i].coordinates.latitude,
                longitude:this.props.api[i].coordinates.longitude,
                __proto__:position.__proto__
            };

            // console.log(b);
            
            var placemark = new WorldWind.Placemark(b, /*eyeDistanceScaling*/true, attributes);
            placemark.label = "Lat " + b.latitude + "\nLon " + b.longitude;
     ...
     for(var i=0;i<this.props.api2.length;i++){
        var attributes = new WorldWind.PlacemarkAttributes(null);
        attributes.imageScale = 0.08;
        attributes.imageOffset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, 0.3, WorldWind.OFFSET_FRACTION, 0.0);
        attributes.imageColor = WorldWind.Color.WHITE;
        ...
        attributes.drawLeaderLine = true;
        attributes.leaderLineAttributes.outlineColor = WorldWind.Color.RED;
        if(this.props.api2[i].value<15){
            attributes.imageSource = "https://i.imgur.com/zGLZKY8.png";}
            else if(this.props.api2[i].value<30){
                attributes.imageSource = "https://i.imgur.com/6nrew9K.png";
                attributes.imageScale = 0.2;
            }
            else{
        ...
        var b={
            latitude:this.props.api2[i].coordinates.latitude,
            longitude:this.props.api2[i].coordinates.longitude,
            __proto__:position.__proto__
        };
 ...
 for(var i=0;i<this.props.api3.length;i++){
    var attributes = new WorldWind.PlacemarkAttributes(null);
    attributes.imageScale = 0.08;
    attributes.imageOffset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, 0.3, WorldWind.OFFSET_FRACTION, 0.0);
    attributes.imageColor = WorldWind.Color.WHITE;
    ...
    attributes.drawLeaderLine = true;
    attributes.leaderLineAttributes.outlineColor = WorldWind.Color.RED;
    if(this.props.api3[i].value<15){
        attributes.imageSource = "https://i.imgur.com/zGLZKY8.png";}
        else if(this.props.api3[i].value<30){
            attributes.imageSource = "https://i.imgur.com/6nrew9K.png";
            attributes.imageScale = 0.2;
        }
        else{
    ...
    var b={
        latitude:this.props.api3[i].coordinates.latitude,
        longitude:this.props.api3[i].coordinates.longitude,
        __proto__:position.__proto__
    };
...
for(var i=0;i<this.props.api4.length;i++){
    var attributes = new WorldWind.PlacemarkAttributes(null);
    attributes.imageScale = 0.08;
    attributes.imageOffset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, 0.3, WorldWind.OFFSET_FRACTION, 0.0);
    attributes.imageColor = WorldWind.Color.WHITE;
    ...
    attributes.drawLeaderLine = true;
    attributes.leaderLineAttributes.outlineColor = WorldWind.Color.RED;
    if(this.props.api4[i].value<10){
        attributes.imageSource = "https://i.imgur.com/zGLZKY8.png";}
        else if(this.props.api4[i].value<20){
            attributes.imageSource = "https://i.imgur.com/6nrew9K.png";
            attributes.imageScale = 0.2;
        }
        else{
    ...
    var b={
        latitude:this.props.api4[i].coordinates.latitude,
        longitude:this.props.api4[i].coordinates.longitude,
        __proto__:position.__proto__
    };
...
for(var i=0;i<this.props.api5.length;i++){
    var attributes = new WorldWind.PlacemarkAttributes(null);
    attributes.imageScale = 0.08;
    attributes.imageOffset = new WorldWind.Offset(WorldWind.OFFSET_FRACTION, 0.3, WorldWind.OFFSET_FRACTION, 0.0);
    attributes.imageColor = WorldWind.Color.WHITE;
    ...
    attributes.drawLeaderLine = true;
    attributes.leaderLineAttributes.outlineColor = WorldWind.Color.RED;
    if(this.props.api5[i].value<10){
        attributes.imageSource = "https://i.imgur.com/zGLZKY8.png";}
        else if(this.props.api5[i].value<20){
            attributes.imageSource = "https://i.imgur.com/6nrew9K.png";
            attributes.imageScale = 0.2;
        }
        else{
    ...
    var b={
        latitude:this.props.api5[i].coordinates.latitude,
        longitude:this.props.api5[i].coordinates.longitude,
        __proto__:position.__proto__
    };
    ...
    // console.log(layer);
        ...
        layer.addRenderable(placemark);
                ...
                // layer.renderables[0].position.latitude=0;
                ...
                // Add the placemark to the Markers component
                this.props.markers.addMarker(placemark);
                // this.props.markers.addMarker(placemark1);
        }
        // }
    }, 
    {
        key:'haha',
        value: function haha(position){
            var b={
                latitude:0,
                longittude:0,
                __proto__:position.__proto__
            ...
            console.log(position);
            console.log(b);
            // var source=[{latitude:100,longitude:0},{latitude:0,longitude:0}];
            // // for(var i=0;i<source.length;i++){
            //     return this.dropMarkerCallback;
            // //}
        }
    },
    {
        ...
        value: function render() {
            ...
            return React__default.createElement(
                ...
                React__default.createElement(
                    ...
                    React__default.createElement('img', { className: style$1.image, src: 'https://i.imgur.com/zGLZKY8.png', alt: 'Marker' })
                ),
                React__default.createElement(
...
Tools.pushpins = ["https://i.imgur.com/5E01lFc.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-green.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-blue.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-orange.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-teal.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-purple.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-white.png", "https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/images/pushpins/castshadow-black.png"];
